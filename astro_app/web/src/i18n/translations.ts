...
export const UI_TEXT: Dict = {
  ...
  stateProvince: { en: "State / Province", ta: "மாநிலம் / மாகாணம்" },
  ...
  rahuYamaGulikaTitle: { en: "Rahukalam / Yamakandam / Gulikaal", ta: "ராகு காலம் / எமகண்டம் / குளிகை காலம்" },
  rahukalam: { en: "Rahukalam", ta: "ராகு காலம்" },
  yamakandam: { en: "Yamakandam", ta: "எமகண்டம்" },
  gulikaal: { en: "Gulikaal", ta: "குளிகை காலம்" },
  rahuYamaGulikaCaveat: {
    en: "Using the standard Panchangam segment rule -- not yet confirmed by the astrologer for this app specifically.",
    ta: "வழக்கமான பஞ்சாங்க முறையைப் பயன்படுத்துகிறது -- இந்த ஆப்பிற்கென ஜோதிடரிடம் இன்னும் உறுதி செய்யப்படவில்லை.",
  },
